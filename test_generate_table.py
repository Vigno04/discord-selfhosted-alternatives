...
class TestLoadJson(unittest.TestCase):
    ...
    def test_load_valid_json(self):
        ...
        test_data = {
            "projects": [{"name": "Test", "repo": "test/repo"}],
            "features": [],
        }
    ...
    def test_load_json_with_utf8(self):
        ...
        test_data = {"projects": [{"name": "Test 中文", "emoji": "✅"}]}
...
class TestGenerateTableHeader(unittest.TestCase):
    ...
    def test_header_with_single_project(self):
        ...
        projects = [{"name": "TestApp", "repo": "user/testapp"}]
...
class TestGenerateBadgeRow(unittest.TestCase):
    ...
    def test_basic_badge_row(self):
        ...
        projects = [{"name": "Test", "repo": "user/test", "branch": "main"}]
    ...
    def test_badge_row_with_branch(self):
        ...
        projects = [{"name": "Test", "repo": "user/test", "branch": "develop"}]
...
class TestGenerateLicenseRow(unittest.TestCase):
    ...
    def test_custom_license(self):
        ...
        projects = [{"name": "Test", "repo": "user/test", "license_custom": "GPL-3.0"}]
...
class TestGenerateDefaultRow(unittest.TestCase):
    ...
    def test_default_row_with_values(self):
        ...
        feature = {"name": "Web App", "link": "features.md#web-app"}
        projects = [
            {"name": "App1", "web_app": "8"},
            {"name": "App2", "web_app": "x"},
    ...
    def test_default_row_with_missing_values(self):
        ...
        feature = {"name": "New Feature", "link": "features.md#new"}
        projects = [
    ...
    def test_default_row_with_urls(self):
        ...
        feature = {"name": "Android App", "link": "features.md#android"}
        projects = [
            {
                "name": "App1",
                "android_app": "8",
    ...
    def test_default_row_no_link(self):
        ...
        feature = {"name": "Test Feature", "link": None}
        projects = [{"name": "App1", "test_feature": "5"}]
    ...
    def test_default_row_feature_name_conversion(self):
        ...
        feature = {"name": "Object/Face Recognition", "link": "features.md#object-face"}
        projects = [{"name": "App1", "object_face_recognition": "9"}]
...
class TestGenerateComparisonTable(unittest.TestCase):
    ...
    def test_comparison_table_structure(self):
        ...
        data = {
            "projects": [{"name": "Test", "repo": "user/test", "branch": "main"}],
            "features": [{"name": "Test Feature", "link": "features.md#test"}],
        }
    ...
    def test_comparison_table_with_logo_processor(self):
        ...
        data = {
            ...
            "features": [
                {"name": "Logo", "link": None, "processor": "generate_logo_row"}
            ],
        }
    ...
    def test_comparison_table_with_default_processor(self):
        ...
        data = {
            "projects": [{"name": "Test", "repo": "user/test", "web_app": "8"}],
            "features": [{"name": "Web App", "link": "features.md#web-app"}],
        }
...
class TestValidateProjectsJson(unittest.TestCase):
    """Test cases for validate_projects_json function."""

    def test_valid_data_passes(self):
        """Test that valid data passes validation without errors."""
        data = {
            "projects": [
                {
                    "name": "App1",
    ...
    def test_multiple_missing_fields_detected(self):
        ...
        data = {
            "projects": [
                {
                    "name": "App1"
                    # Missing repo, logo_url, logo_alt
                }
            ],
            "features": [],
        }
    ...
    def test_unmapped_keys_show_correct_projects(self):
        ...
        self.assertIn("App3", bad_key_line)
        self.assertNotIn("App2", bad_key_line)

    def test_combined_errors_all_reported(self):
        """Test that both missing fields and unmapped keys are reported together."""
        data = {
            "projects": [
                {
                    "name": "App1",
    ...
    def test_standard_keys_not_flagged(self):
        ...
        # Should not raise - all keys are standard
        try:
            validate_projects_json(data)
        except ValueError:
    ...
    def test_feature_variants_recognized(self):
        ...
        # Should not raise - all variants are valid
        try:
            validate_projects_json(data)
        except ValueError:
            self.fail(
                "validate_projects_json raised ValueError for valid feature variants"
            )

    def test_feature_name_conversion(self):
        """Test that feature names with spaces and slashes are converted correctly."""
        data = {
            "projects": [
                {
                    "name": "App1",
            ...
            "features": [{"name": "iOS/Android App", "description": "test"}],
        }

        # Should not raise - feature name is converted correctly
        try:
            validate_projects_json(data)
        except ValueError:
            self.fail(
                "validate_projects_json raised ValueError for converted feature name"
            )
